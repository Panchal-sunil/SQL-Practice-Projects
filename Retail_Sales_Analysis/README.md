...
1. **Write a SQL query to retrive all colums for sales made on '2022-11-05**:
```sql
SELECT *
 FROM retail_sales 
...
4. **Write a SQL query to find the average age of customers who purchesed item from the 'Beauty' category.**:
```sql
SELECT 
